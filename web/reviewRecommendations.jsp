                            ...
                            <div class="caption">
                                <div class="thumbnail "> <img src="${item.imageURL}" style="width:120px;height:200px;" class="img-responsive"></a>
                                    ...
                                    <p>
                                        ...
                                        <a>&nbsp;&nbsp;</a>
                                        <a href="./adminServlet?type=reviewRecommendations&isbn=${item.ISBN}" class="btn btn-primary" role="button"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span>Purchase</a>
