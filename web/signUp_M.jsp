...
<html lang="en">
    ...
    <body>
        <div class="container">
            <div style="font-size: 16px"><a href="http://localhost:8080/308code/editUser.jsp">Back to HomePage</a></div>
            <form class="form-signup" method="post" action="http://localhost:8080/308code/signup_Manager" class="ibm-row-form" name="register" id="registerform" >
