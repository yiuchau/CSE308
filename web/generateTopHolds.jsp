<%-- 
    Document   : generateTopHolds
    Created on : Apr 21, 2016, 12:44:55 AM
    Author     : Brian Lee
--%>
...
<html>
    <hr>
<h2 class="text-center">Top Holds</h2>
<hr>
<div class="container">
  <div class="row text-center">
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="Description.html"> <img src="images/p1_.jpg" alt="Thumbnail Image 1" class="img-responsive">
        <div class="caption">
          <h3>Product</h3>
